...
## Practice Exercise (Ex 1.18)
*   **Objective**: To internalize the duration of a half note.
*   **Method**: While counting every beat out loud (1-2-3-4), play half notes on [[Beat]] 1 and [[Beat]] 3 of every measure. Sustain the sound for two beats for each half note.
*   **Example**:
    *   Measure 1: Play on 1 (sustain 2), Play on 3 (sustain 4).
...
*   **Example**:
    ...
    *   Measure 2: Play on 1 (sustain 2), Play on 3 (sustain 4).
    *   Measure 3: Play on 1 (sustain 2, 3, 4).
    *   Measure 4: Play on 1 (sustain 2), Play on 3 (sustain 4).

## Pro-Tip for Drummers
*   **Rhythmic Phrasing**: Half notes are crucial for creating longer, sustained rhythmic phrases in grooves and fills. They provide a sense of space and allow for rhythmic breathing.
