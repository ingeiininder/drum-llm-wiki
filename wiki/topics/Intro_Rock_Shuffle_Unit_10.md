...
tags: [intro, rock shuffle, floor tom, ride cymbal, vibe, performance notes, drum kit]
last_updated: 2023-10-27
---

# Intro (Rock Shuffle - Unit 10)
The introduction to the Unit 10 rock shuffle tune sets the mood and establishes the core groove.

**Key Characteristics:**
*   **Length**: The intro is eight bars long.
*   **Groove**: It features a one-bar [[Rock Shuffle]] feel, which is established immediately.
*   **Instrumentation - Drums**: A unique aspect of this intro is the use of the [[Floor Tom]] as the primary ride surface. This choice helps create a "darker and ominous vibe" compared to a standard [[Ride Cymbal]] or [[Hi-Hat]].
