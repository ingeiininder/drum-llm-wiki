...
tags: [musical form, structure, arrangement, A section, B section, D.S. al Coda, coda, modern rock]
last_updated: 2023-10-27
---

# ABAB Form
The `[[ABAB Form]]` is a common `[[Musical Form]]` or `[[Structure]]` used in this study, particularly within the `[[Modern Rock]]` context of Unit 9, Chapter 1.

Key characteristics of this specific ABAB structure:
*   **Section Length:** Both the `[[A Section]]` and `[[B Section]]` are eight bars long.
*   **Repetitions:** Each section is played three times.
*   **Total Bars:** This creates a total of 48 bars (24 bars for A sections, 24 bars for B sections).
