...
**Pro-Tip:** Focus on the efficiency of motion between these strokes. The goal is to move the stick to the correct height for the next note with minimal wasted energy. Practice slowly, isolating each stroke type, then gradually combine them into smooth, continuous patterns.