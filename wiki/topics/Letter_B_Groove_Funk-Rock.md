...
tags: [groove, funk-rock, syncopation, hi-hat, bass drum, snare drum, 16th notes, two-bar phrase, subdivision, exercise]
...
**Pro-Tip:** When practicing a `[[Two-Bar Phrase]]`, ensure you can play the entire phrase smoothly and consistently before looping it. Focus on the transition between the first and second bars, and how the phrase resolves or leads into the next repetition. The "Medium; Thick Hi-Hat" instruction suggests a specific `[[Hi-Hat Technique]]` for a fuller, more sustained sound, often achieved by playing closer to the bell or with a slightly looser grip.