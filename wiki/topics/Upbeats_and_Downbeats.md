...
tags: [rhythm, pulse, music theory, drumming fundamentals]
...
*   **Definition**: The upbeat is the weaker pulse that anticipates the next downbeat. It often feels like a lift or a push towards the next strong beat.
*   **Feel**: Upbeats create momentum and drive in music.
*   **Notation**: In eighth notes (1 & 2 & 3 & 4 &), the "&" (and) represents the upbeat. In 16th notes (1 e & a), the "e", "&", and "a" are all considered upbeats relative to the main "1" downbeat, with the "&" being the upbeat of the eighth note subdivision.
...
Practice playing simple patterns, consciously emphasizing either the downbeats or the upbeats. For example, play [[Quarter Notes]] on the [[Bass Drum]] (downbeats) and [[Eighth Notes]] on the [[Hi-Hat]], then try playing the hi-hat on the upbeats only. This helps to internalize the different feels and develop rhythmic versatility.