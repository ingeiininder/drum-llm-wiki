...
tags: [composition, arrangement, guitar, harmony, musical elements, song form]
last_updated: 2023-10-27
---

# Particular Guitar Riff and Chord Structure
In musical forms like the `[[ABAB 32-Bar Form]]`, sections are not only defined by a `[[Different Rhythm (or Groove)]]` but also by a "Particular `[[Guitar Riff]]` and `[[Chord Structure]]`." These harmonic and melodic elements provide the underlying musical context that guides the drummer's part.
