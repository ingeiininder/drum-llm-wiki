...
tags: [music theory, notation, ties, bar line, duration]
last_updated: 2023-10-27
---

# Extending a Note Value Across a Bar Line
One of the primary uses of [[Ties]] in musical notation is to allow a [[Note Value]] to extend beyond the allowable number of beats within a single [[Measure]]. This is essential for rhythmic continuity and for creating [[Phrasing]] that transcends the visual breaks of [[Bar Line]]s.

**Why it's Used:**
*   **Rhythmic Continuity**: Prevents a long note from being prematurely cut off by a bar line.
*   **Complex Phrasing**: Enables the notation of rhythms that naturally flow across measures, creating a sense of forward motion.
