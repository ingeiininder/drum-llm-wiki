...
type: exercise
book_id: READ2
source: [IMG_0815, IMG_0816, IMG_0817]
unit: 2
tags: [mobility, drumset, subdivisions, orchestration]
last_updated: 2026-04-19
---

# Drumset Mobility: Mixed Note Values
...
### Execution Steps
1. **Snare Only**: Play the entire rhythmic sequence on the snare to ensure timing accuracy.
2. **Kit Orchestration**: Move the hands to the toms as written in the curriculum.
3. **Leading Hand**: Maintain a Right-Hand lead for all alternating strokes to build consistency in movement patterns.