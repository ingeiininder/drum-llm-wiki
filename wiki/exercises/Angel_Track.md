...
type: exercise
book_id: MI_CURR
source: IMG_1542, IMG_1543, IMG_1544
unit: 5
tags: [jazz_fusion, drum_and_bass, latin_flair, linear_drumming]
...
- **Dynamic Contrast**: Moving from quiet mid-head strokes and [[Buzz Rolls]] to powerful rim-shots.
- **Orchestration**: Strategic switching between different hi-hats (e.g., X-hats and main hats) to recreate a "programmed" electronic feel.
- **Technique Switching**: Rapidly alternating between [[Finger Control]] for 16th-note groups and [[Wrist Control]] (locked grip) for powerful 8th-note passages.
