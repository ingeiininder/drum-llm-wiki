...
type: exercise
book_id: TECH3_4
source: [IMG_1314, IMG_1315]
unit: 3
tags: [drumset, orchestration, paradiddles, independence, grooves]
...
### Dynamic Balance
The "Information Gain" here lies in the **Sound Balance**. The accents must be distinct, but the ghost notes must be audible enough to provide "texture" without overwhelming the groove. 

### Pro-Tip
When orchestrating to the toms, ensure your "up motion" is prepared. As you play a ghost note on the snare, your other hand should already be moving toward the tom for the upcoming accent.