...
type: exercise
book_id: TECH1_2
source: IMG_1073, IMG_1074, IMG_1075, IMG_1076, IMG_1077
unit: 8
tags: [cut_time, samba, funk, modulation]
...
*   **Samba**: Written in Cut Time to simplify ensemble figures using larger note values. Stylistically, Samba is felt as a two-bar pattern in "2," making Cut Time the preferred notation.
...
2.  **Ensemble Figures**: In Cut Time, figures are often written as eighth notes or dotted quarters. Despite the "larger" look of the notes, they move quickly due to the modulation.
3.  **Setup**: Use double stops between hands for setup fills in the Samba section to allow the feet to maintain the repetitive bass drum pattern.