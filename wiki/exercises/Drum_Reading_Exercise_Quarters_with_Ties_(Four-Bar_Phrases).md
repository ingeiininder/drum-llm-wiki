...
tags: [drum_reading, quarter_notes, ties, four-bar_phrases, rhythm, sustain]
...
*   **Sustain/Release:** Understanding how ties affect the perceived sustain or release of a drum sound, even if the drum itself doesn't sustain.
...
**Pro-Tip:** When practicing tied notes, mentally (or physically, if applicable) "hold" the note across the tie. For drums, this often means understanding that the sound initiated by the first note continues through the duration of the tied notes, or that a specific limb remains engaged for the combined duration.