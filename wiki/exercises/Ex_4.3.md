...
tags: [16th notes, two-handed, groove, exercise, chart, song form, abab 32-bar form, fills]
last_updated: 2023-10-27
---

# Ex 4.3
`Ex 4.3` is an exercise that demonstrates the complete `[[ABAB 32-Bar Form]]` by combining the 'A' section `[[Two-Handed 16th-Note Groove]]` (from `[[Ex 4.1]]`) and the 'B' section `[[Two-Handed 16th-Note Groove]]` (from `[[Ex 4.2]]`) into a full 32-bar structure.

**Key Elements:**
*   **ABAB Structure**: The exercise clearly outlines the alternation of 'A' and 'B' sections, each comprising an `[[Eight-Bar Phrase]]`.
*   **Groove Application**: It shows how the distinct `[[Different Rhythm (or Groove)]]` of each section contributes to the overall form.
